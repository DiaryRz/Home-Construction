            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                    <table id="authorsTable" class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Numero du client</th>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Prix avec finition</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Prix deja payer</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Pourcentage deja payer</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                                <p style="text-align: right;" class="text-xs text-secondary mb-0"><?php echo $devis->numero; ?></p>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <p style="text-align: right;" class="text-xs text-secondary mb-0"><?php echo number_format($devis->prixavaecfinition, 2, ',', ' ' ); ?></p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p style="text-align: right;" class="text-xs text-secondary mb-0"><?php echo number_format($devis->prixdejapayer, 2, ',', ' ' ); ?></p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p style="text-align: right;" class="text-xs text-secondary mb-0"><?php echo number_format($devis->pourcentagedejapayer, 2, ',', ' ' ); ?></p>
                                        </td>
                                        <td>
                                            <span class="badge badge-sm bg-gradient-success">
                                                <a href="<?php echo base_url("DevisAdminController/details") ?>?iddevis=<?php echo $devis->iddevis ?>">Voir les details des travaux</a>
                                            </span>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
