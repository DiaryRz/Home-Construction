                                ...
                                <?php foreach ($listedevis as $devis): ?>
                                    <tr>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <p style="text-align:right;" class="text-xs text-secondary mb-0"><?php echo number_format($devis->pourcentagefinition, 2, ',', ' ' ); ?></p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                        ...
                                        <td>
                                            <span class="badge badge-sm bg-gradient-success">
                                                <a href="<?php echo base_url("DevisClientController/Payer") ?>?iddevis=<?php echo $devis->iddevis ?>">Payer</a>
                                            </span>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
